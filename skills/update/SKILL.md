...
3. **Report upgrade summary:**
   - Confirm that universal operating rules (`.ai/AI_BASE.md`) have been upgraded to the latest version (v2.5.0).
   ...
   - Inform the user that the project is now upgraded to v2.5.0 with Benchmark Verifiability, Anti-Poisoning Telemetry Engine, Completion Honesty Protocol, No-Assumption Clause, Critical Invariants, native Research, Audits, automated `/decision` ADR logging, empirical `/benchmark` telemetry, and UX review heuristics.
